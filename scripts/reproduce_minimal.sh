...
temperature=0.8
limit=5
dataset_args="++max_num_from_same_story=1 ++split=both ++human_experiments=8 ++limit=$limit" # T_h dataset (47 questions)
...
#python3 -m core.judge exp_dir=$exp_dir +experiment='debate_tie' $judge_args
...
echo "python3 -m core.scoring.accuracy exp_dir=$exp_dir +experiment='debate_tie' $score_args"
python3 -m core.scoring.accuracy exp_dir=$exp_dir +experiment='debate_tie' $score_args
